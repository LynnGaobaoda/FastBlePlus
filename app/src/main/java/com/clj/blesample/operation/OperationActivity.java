...
import com.clj.blesample.MyActivity.data_show_activity;
import com.clj.blesample.MyActivity.remote_ctr_activity;
...
public class OperationActivity extends AppCompatActivity implements Observer {
    ...
    private void initView() {
        ...
        Button btn_remote_ctrl = (Button) findViewById(R.id.btn_remote_ctrl);
        ...
        btn_remote_ctrl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (BleManager.getInstance().isConnected(bleDevice)) {
                    Intent intent = new Intent(OperationActivity.this, remote_ctr_activity.class);
                    intent.putExtra(remote_ctr_activity.KEY_DATA, bleDevice);
                    startActivity(intent);
                }
            }
        });

        Button btn_data_show = findViewById(R.id.btn_data_show);
        btn_data_show.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (BleManager.getInstance().isConnected(bleDevice)) {
                    Intent intent = new Intent(OperationActivity.this, data_show_activity.class);
                    intent.putExtra(data_show_activity.KEY_DATA, bleDevice);
                    startActivity(intent);
                }
            }
        });
